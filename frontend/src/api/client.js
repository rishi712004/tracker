...
export const issues = {
  ...
  update: (projectId, issueId, data) => http.patch(`/projects/${projectId}/issues/${issueId}`, data),
  ...
  delete: (projectId, issueId) => http.delete(`/projects/${projectId}/issues/${issueId}`),
};

export const comments = {
  list: (issueId) => http.get(`/issues/${issueId}/comments/`),
  create: (issueId, body) => http.post(`/issues/${issueId}/comments/`, { body }),
  delete: (issueId, commentId) => http.delete(`/issues/${issueId}/comments/${commentId}`),
};
